...
spawn(function() 
    ...
    wait(1.5)
    require(game.ReplicatedStorage.Notification).new("<Color=Red>Thiên BloxFruits chào ae<Color=/>"):Display()
    wait(.5)
...
local Window = OrionLib:MakeWindow({Name = "Thiên BloxFruits", HidePremium = false, IntroText = "Thiên BloxFruits⚜️", SaveConfig = true, ConfigFolder = "NightHub"})



OrionLib:MakeNotification({
    Name = "Thiên BloxFruits",
...
W:AddLabel("Thiên BloxFruits SCRIPT")
W:AddLabel("DiscordThiên BloxFruits")
local Section = W:AddSection({
    Name = "Status"
})
...
pcall(function()
    while wait() do
        if _G.AutoEliteHunter then
            if game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == true then
                OrionLib:MakeNotification({
                    Name = "Thiên BloxFruits(Noitification)",
